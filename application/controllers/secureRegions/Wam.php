...
class Wam extends Main
{
	...
	function index()
	{
		...
		$this->data["late_logins_details"] = $this->Attendance_Model->get_late_logins(
			array(
				"current_day" => 1,
		...
		$this->data["last_day_late_logins_details"] = $this->Attendance_Model->get_late_logins(
			array(
				"last_day" => 1,
				"user_employee_record_status" => "1and2",
				"attendance_record_status" => 1
		...
		// $this->data["late_logins_count"] = $this->Attendance_Model->get_late_logins_only_count(
		// 	array(
		// 		"today" => 1,
		// 		"attendance_record_status" => 1
		...
		$this->data["early_logouts_details"] = $this->Attendance_Model->get_early_logouts(
			array(
				"current_day" => 1,
				"user_employee_record_status" => "1and2",
				"attendance_record_status" => 1
		...
		$this->data["last_day_early_logouts_details"] = $this->Attendance_Model->get_early_logouts(
			array(
				"last_day" => 1,
				"user_employee_record_status" => "1and2",
				"attendance_record_status" => 1
		...
		// $this->data["early_logouts_count"] = $this->Attendance_Model->get_early_logouts_only_count(
		// 	array(
		// 		"today" => 1,
		// 		"attendance_record_status" => 1
		...
		$this->data["missed_logouts_details"] = $this->Attendance_Model->get_missed_logouts(
			array(
				"current_day" => 1,
				"user_employee_record_status" => "1and2",
				"attendance_record_status" => 1
		...
		$this->data["last_day_missed_logouts_details"] = $this->Attendance_Model->get_missed_logouts(
			array(
				"last_day" => 1,
				"user_employee_record_status" => "1and2",
				"attendance_record_status" => 1
		...
		// $this->data["missed_logouts_count"] = $this->Attendance_Model->get_incomplete_logouts_only_count(
		// 	array(
		// 		"today" => 1,
		// 		"attendance_record_status" => 1
		...
		$this->data["get_employees_absent_on_date_data"] = $this->Attendance_Model->get_employees_absent_on_date(
			array(
				// "date_dash_ymd" => date('Y-m-d', strtotime('-1 day')),
				"user_employee_record_status" => "1and2",
				"date_dash_ymd" => date('Y-m-d'),


			)
		);
		$this->data["last_day_get_employees_absent_on_date_data"] = $this->Attendance_Model->get_employees_absent_on_date(
			array(
				"user_employee_record_status" => "1and2",
				"date_dash_ymd" => date('Y-m-d', strtotime('-1 day')),
		...
		// $this->data["get_employees_absent_on_date_data_count"] = 0;
		// if (!empty($this->data["get_employees_absent_on_date_data"])) {
		// 	$this->data["get_employees_absent_on_date_data_count"] = count($this->data["get_employees_absent_on_date_data"]);
		// }
