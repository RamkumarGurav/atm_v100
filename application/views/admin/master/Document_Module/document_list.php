                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='ft.document_name' <?php if ($field_name == 'ft.document_name') {
                                                        echo 'selected';
                                                    } ?>>Document
                                                        Name</option>
                                                    <option value='ft.document_address' <?php if ($field_name == 'ft.document_address') {
                                                        echo 'selected';
                                                    } ?>>
                                                        Document Address</option>
                                                </select>
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $urm->document_id; ?>" /></td>
                                                <?php } ?>
                                                <td><a
                                                        href="<?php echo MAINSITE_Admin . $user_access->class_name . "/document-view/" . $urm->document_id ?>"><?php echo $urm->document_name ?></a>
                                                </td>
                                                <!-- <td><?php echo $urm->document_address ?></td> -->
                                                <?php   /*?><td><?php  echo $urm->dial_code?></td><?php  */ ?>
                                                <!-- <td><?php echo $urm->document_code ?></td> -->
