            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $document_data->document_name ?></h3>
                        <div class="float-right">
                            <?php
                            if ($user_access->add_module == 1 && false) {
                                ?>
                                <a href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/document-edit">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/document-edit/<?php echo $document_data->document_id ?>">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_open(MAINSITE_Admin . "$user_access->class_name/document-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                            <input type="hidden" name="task" id="task" value="" />
                            <?php echo $this->session->flashdata('alert_message'); ?>

                            <table id="" class="table table-bordered table-hover myviewtable">
                                <tbody>
                                    <tr>
                                        <td>
                                            <strong class="full">Data Base Id</strong>
                                            <?php echo $document_data->document_id ?>
                                        </td>
                                        <td>
                                            <strong class="full">Document Name</strong>
                                            <?php echo $document_data->document_name ?>
                                        </td>
                                        <!-- <td>
                                            <strong class="full">Document Address</strong>
                                            <?php echo $document_data->document_address ?>
                                        </td> -->

                                        <!-- <td>
                                        <strong class="full">Document Code</strong>
                                        <?php echo $document_data->document_code ?>
                                    </td> -->

                                        <td>
                                            <strong class="full">Added On</strong>
                                            <?php echo date("d-m-Y h:i:s A", strtotime($document_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <?php echo $document_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?php if (!empty($document_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($document_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($document_data->updated_by_name)) {
                                                echo $document_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if ($document_data->status == 1) { ?> Active <i
