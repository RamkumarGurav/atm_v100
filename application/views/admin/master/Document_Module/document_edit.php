...
if (!empty($document_data)) {
	...
	// $document_address = $document_data->document_address;
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<?php if (!empty($document_data)) { ?>
							<li class="breadcrumb-item"><a
									href="<?php echo MAINSITE_Admin . $user_access->class_name . "/document_view/" . $document_id ?>">View</a>
							</li>
						<?php } ?>
			...
			<div class="col-12">
				...
				<div class="card">
					...
					<div class="card-header">
						<h3 class="card-title"><?php echo $document_name ?> <small><?php echo $record_action ?></small></h3>
					</div>
					<!-- /.card-header -->
					<?php
					if ($user_access->view_module == 1 || true) {
						...
						<div class="card-body">
							...
							<?php echo form_open(MAINSITE_Admin . "$user_access->class_name/documentDoEdit", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
							<input type="hidden" name="document_id" id="document_id" value="<?php echo $document_id ?>" />
							<input type="hidden" name="redirect_type" id="redirect_type" value="" />
							<div class="row">
								<div class="col-sm-6 row">
									<label for="inputEmail3" class="col-sm-4 label_content text-right mt-2">Document Name </label>
									<div class="col-sm-6">
										<input type="text" class="form-control form-control-sm" required id="document_name"
											name="document_name" value="<?php echo $document_name ?>" placeholder="Document name">
