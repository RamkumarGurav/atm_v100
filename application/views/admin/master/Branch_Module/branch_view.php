            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $branch_data->branch_name ?></h3>
                        <div class="float-right">
                            <?php
                            if ($user_access->add_module == 1 && false) {
                                ?>
                                <a href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/branch-edit">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/branch-edit/<?php echo $branch_data->branch_id ?>">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <?php echo $branch_data->branch_id ?>
                                        </td>
                                        <td>
                                        ...
                                        <!-- <td>
                                            ...
                                            <?php echo $branch_data->branch_address ?>
                                        </td> -->

                                        <!-- <td>
                                        <strong class="full">Branch Code</strong>
                                        <?php echo $branch_data->branch_code ?>
                                    </td> -->

                                        <td>
                                            <strong class="full">Added On</strong>
                                            <?php echo date("d-m-Y h:i:s A", strtotime($branch_data->added_on)) ?>
                                        </td>
                                        <td>
                                            <strong class="full">Added By</strong>
                                            <?php echo $branch_data->added_by_name ?>
                                        </td>
                                        <td>
                                            <strong class="full">Updated On</strong>
                                            <?php if (!empty($branch_data->updated_on)) {
                                                echo date("d-m-Y h:i:s A", strtotime($branch_data->updated_on));
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($branch_data->updated_by_name)) {
                                                echo $branch_data->updated_by_name;
                                            } else {
                                                echo "-";
                                            } ?>
                                        </td>
                                        <td>
                                            ...
                                            <?php if ($branch_data->status == 1) { ?> Active <i
