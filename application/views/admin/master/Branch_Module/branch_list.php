                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='ft.branch_name' <?php if ($field_name == 'ft.branch_name') {
                                                        echo 'selected';
                                                    } ?>>Branch
                                                        Name</option>
                                                    <option value='ft.branch_address' <?php if ($field_name == 'ft.branch_address') {
                                                        echo 'selected';
                                                    } ?>>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($branch_data as $urm) {
                                            ...
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <td><a
                                                        href="<?php echo MAINSITE_Admin . $user_access->class_name . "/branch-view/" . $urm->branch_id ?>"><?php echo $urm->branch_name ?></a>
                                                </td>
                                                <!-- <td><?php echo $urm->branch_address ?></td> -->
                                                <?php   /*?><td><?php  echo $urm->dial_code?></td><?php  */ ?>
                                                <!-- <td><?php echo $urm->branch_code ?></td> -->
