      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            <div class="inner p-3">
              <h3>
                <!-- <?= $late_logins_count ?> -->
                <?= count($late_logins_details) ?>
              </h3>

              <p>Late Logins on Today</p>
            </div>
            <div class="icon">
            ...
            <a href="<?= MAINSITE_Admin . "user_employee/Attendance-Module/today_attendance_report_list" ?>"
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            <div class="inner p-3">
              <h3>
                <!-- <?= $early_logouts_count ?> -->
                <?= count($early_logouts_details) ?>
              </h3>

              <p>Early Logouts on Today</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-warning">
            <div class="inner p-3">
              <h3>
                <!-- <?= $incomplete_logouts_count ?> -->
                <?= count($missed_logouts_details) ?>
              </h3>

              <p>Missed Logouts on Today</p>
            </div>
            <div class="icon">
              <i class="fas  fa-clock"></i>
            </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            <div class="inner p-3">
              <h3>
                <?= count($get_employees_absent_on_date_data) ?>
              </h3>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            <div class="inner p-3">
              <h3>
                <!-- <?= $late_logins_count ?> -->
                <?= count($last_day_late_logins_details) ?>
              </h3>

              <p>Late Logins on Yesterday</p>
            </div>
            <div class="icon">
              <i class="fas fa-running"></i>
              <!-- <i class="ion ion-bag"></i> -->
            ...
            <a href="<?= MAINSITE_Admin . "user_employee/Attendance-Module/yesterday_attendance_report_list" ?>"
              class="small-box-footer">More info
              <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            <div class="inner p-3">
              <h3>
                <!-- <?= $early_logouts_count ?> -->
                <?= count($last_day_early_logouts_details) ?>
              </h3>

              <p>Early Logouts on Yesterday</p>
            </div>
            <div class="icon">
              <i class="fas fa-clock "></i>
            </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-warning">
            <div class="inner p-3">
              <h3>
                <!-- <?= $incomplete_logouts_count ?> -->
                <?= count($last_day_missed_logouts_details) ?>
              </h3>

              <p>Missed Logouts on Yesterday</p>
            </div>
            <div class="icon">
              <i class="fas  fa-clock"></i>
            </div>
        ...
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            <div class="inner p-3">
              <h3>
                <?= count($last_day_get_employees_absent_on_date_data) ?>
              </h3>

              <p>Absent on Yesterday</p>
            </div>
            <div class="icon">
              <i class="fas fa-ban "></i>
            </div>
