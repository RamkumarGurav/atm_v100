...
define('__email_user_id__', "2000701148");
define('__email_user_password__', "MAhDxE");
define('__from_email__', "noreply@marswebsolution.com");

define('__sms_user_id__', "wanderershub");
define('__sms_user_password__', "fv6IW6jUn");

define('_registration_', "Signup");  // for login
define('_forgot_password_', "Forgot-password");  // for login
